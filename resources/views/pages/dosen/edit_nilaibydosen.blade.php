...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form method="post" action="{{'/nilaimahasiswa/'.$data->no_nilai}}">
                    @csrf
                    @method('PUT')
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" id="id_matkul" name="id_matkul" value="{{$data->id_matkul}}" class="form-control" required>
                    ...
                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" id="nim" name="nim" class="form-control" value="{{$data->nim}}" required>
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-3 col-xs-6">
                        <div class="form-group form-float ">
                            <div class="form-line">
                                <input type="text" id="angka" name="angka" class="form-control" value="{{$data->angka}}" required>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" id="tahun_ajaran" name="tahun_ajaran" value="{{$data->tahun_ajaran}}" class="form-control" required>
